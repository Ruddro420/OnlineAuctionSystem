                ...
                <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('product.upload.edit' ,$value->id)}}" title="Edit" type="button" class="btn btn-success"><i class="fa-solid fa-edit"></i></a>
                        
                        <a href="{{route('product.upload.delete' ,$value->id)}}" title="Delete" id="delete" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>

                        <a href="{{route('product.upload.customer.details' ,$value->id)}}" title="view" type="button" class="btn btn-info"><i class="fa-solid fa-eye"></i></a>

                        @if (Auth::user()->usertype=='admin' || Auth::user()->usertype=='Customer')
                          <a href="{{route('product.upload.bid.view' ,$value->id)}}" title="view" id="view" class="btn btn-dark"><i class="fa fa-gavel" aria-hidden="true"></i></a>
                          @endif
                      </td>
                    </tr>
                    @endforeach
